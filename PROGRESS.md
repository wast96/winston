...
**ch20 (杜月笙与恒社, "Du Yuesheng and the Heng Society"), Guo Lanxin (郭兰馨), printed 300-320, PDF 309-329.** 53 body paragraphs (54 pairs with the byline), 17 notes, +116 glossary rows (glossary 683 total; book 348 notes). The book's anatomy of Du's disciple network: the Heng Society's 1932 founding and sham civic charter, its real power lodged in Du alone; the rise through concession chaos, staged philanthropy and labor-dispute mediation (the French tramway and postal strikes); the induction rite and Wan Molin the gatekeeper; the emblem, the monthly, the gambling; the roster of members by sector; the wartime arc through Hong Kong (the relief commission, the Red Cross cover, the Shanghai Unification Committee) and Chongqing (the branch, the Lu Jingshi vs Bian Dingyuan factions, the Zhonghua Trust and the Dai Li-run Tongji Company yarn-and-cloth smuggling); the 1945 return, the Wu Shaoshu feud, the postwar premises saga, and the society's dissolution in 1949 with a membership estimate of about 1,500.

**AUTHOR NAME CORRECTED. The byline is 郭兰馨 (Guo Lanxin), not the HANDOFF's provisional 郭兰世.** Verified on the PDF p309 title block and confirmed twice in the p320 source footnote that names him. The carry-forward list had it wrong; it is fixed here and in glossary.json.

**This chapter carries the source's own apparatus.** The 1986 reprint folded in, as page-foot footnotes marked with a circled numeral, material from Pang Jingzhou's later piece "Corrections and Supplements to 'Du Yuesheng and the Heng Society'," plus one editors' note (the 1934-founding correction). All ten source footnotes are reproduced as translator notes that say plainly they are the source's, and flag corroboration where a claim is checkable (Yang Du and the Hongxian circle; Miles and SACO; the Gao-Tao defection). The footnote bands (p313-314, p319, p320, p321, p323, p324 twice, p326-327) were crop-read by eye because they are small print the dual-OCR mangles.

**Checks.** parity 54/54; check_numbers 0 unresolved; check_align no outliers (median 5.17 en/han, nothing strays past 2.2x; the three longest paragraphs, the philanthropy build-up, the severance-fee mediation and the postwar-fundraising roster, plus the closing, were tail-verified against the scan clause by clause); check_content clean for ch20 across the whole book; qc_entities 0 misses; check_register within tolerance of ch03 (em-dash 5.9/1k is the translation's own punctuation, allowed). check_apparatus 0 failures. qa_epub PASS (28 documents, 1064 paragraphs, 348 notes all resolving); epubcheck 5.1.0 clean (0 fatals, 0 errors, 0 warnings).

**Crop-verified readings (data/ocr_fixes.json, ch20 key, 33 entries).** The whole director and member roster was eye-read: 陆京士/朱学范/唐世昌/徐懋棠/洪雁宾/张颂椒/唐缵之/朱东山/许也夫/王刚/江肇铭 (the first-term directors), and the sector roster 陈君毅/汪曼云/林美衔/黄香谷/黄造雄/张秉辉/赵君豪/严服周/傅德卫/张克昌/张石川/任矜苹/邵子英/赵培鑫/孙兰亭/汪其俊/周祥生. Other fixes: byline 郭兰馨 (not 郭兰世); the charter 取信互助/效忠国家; 贩鸦片/开赌台 (Du's early trades); the philanthropist list 关炯之/虞洽卿/袁履登; 刘春圃; the guards 叶焯山/高鑫宝; the HK secretaries 徐慕邢/翁左青; 霞飞路; 邱唐; 戴家巷 (the Chongqing address); 舞台圆幕; 杨畹侬 (Mei-school amateur); 六畜飞腾 (the takeover jingle, not 六高); 陶雪生; and the p329 fundraiser names 金素雯/吴稚晖/王懋功/谷正纲.

**noise.txt addition (ch20 block).** 两季 (春秋两季, "spring and autumn," the two meeting seasons; not a data count); the name-numerals 朱品三 and 简贯三 (三 is the name, not 3); 四五花洞 (the opera title, not counts). Nothing else flagged; 三点会/三青团 and 五子登科/六畜飞腾 carry their numbers into the English so they need no noise.

**Cross-chapter reconciliations / glossary discipline.** The batch added 116 rows, then three street names were pulled after check_content (run over every unit) retro-flagged them against earlier chapters: 马浪路 (ch08 renders it "Rue Marco Polo"), 淮海中路 (ch09 renders it "Central Huaihai Road"; ch20 uses "Huaihai Middle Road"), and 建国西路 (rendered differently in ch08). All three are left unglossaried and logged for B10; ch20's own prose keeps its forms. 孔祥熙 = "H. H. Kung" was enforced: the draft rendered it "Kong Xiangxi" and check_content caught the four paragraphs, all corrected. 霞飞路 = "Avenue Joffre" and 马当路 = "Madang Road" agree with the earlier chapters and were kept.

**NOT re-noted in B08b (placed earlier, cross-referenced instead):** the Heng Society itself (ch03/ch15; this chapter IS its full treatment, so no gloss-note is added, only the founding-date and provenance source notes); the Juntong (ch06); the January 28 / 八一三 battles (ch08/ch14); the Sino-American Cooperative Organization (ch15; only the source note's Miles correction appears here); the gang "old man" 老头子 (ch15); the April 12 coup (ch02); Yang Du's Hongxian circle (ch15; the source footnote restates it); Meng Xiaodong, Yu Qiaqing, T. V. Soong, H. H. Kung, Dai Li, Yang Hu, Chen Qun, the yellow unions (all earlier). New reader notes were placed for the Solitary Island, the Cotton and Wheat Loan, the Paoge, the Gao-Tao Incident, the Zhigongtang and Three Dots Society, the opera piece, and Du's Ghost-Festival birthday.

**Voice sheet (new). GUO LANXIN (ch20 narrator):** a Heng Society insider who served as chief secretary of the Chinese Red Cross's Hong Kong head office under Du (identified as the author in one of Pang Jingzhou's footnotes). Documentary and analytical, dense with names, offices and dates; knowing and mildly ironic about the society's machinery and Du's manipulations; frankly critical in the 1980s CPPCC idiom (反动, 御用工具, 人吃人的世界), but precise and not polemical in the particulars.

**Open for B10.** The three ch20 street names above (马浪路/淮海中路/建国西路) join the standing reconciliation list (社会局; the Montauban/Montigny call; the B07b latents ch03 p29, ch13 p39-41 and p58). Also flag the many provisional minor-cast romanizations added this batch for a scholarship pass if better attested forms surface.

**Tooling:** no script changes. work/content_cfg.json regenerated over all 20 translated units (work/ is gitignored).

## B08c (ch21) COMPLETE

**ch21 (杜月笙与戴笠及军统的关系, "Du Yuesheng's Ties to Dai Li and the Juntong"), Guo Xu (郭旭), printed 321-341, PDF 330-350.** 45 body paragraphs (46 pairs with the byline), 20 notes, +78 glossary rows (glossary 757 total; book 368 notes). The byline was crop-verified as 郭旭 = Guo Xu (the dual-OCR read it 郭怒); the narrator is a Juntong finance official, later head of the Bureau of Confidential Investigation's management office, so the whole chapter is an accountant's-eye view of the money and machinery between Du and Dai Li's secret service. Structure: three numbered sections, the middle one carrying seven titled subsections. Section one dates the Du-Dai acquaintance to about 1924 via two anecdotes (Dai the down-and-out drifter lodging with his cousin Zhang Guanfu; the 许忠五 gambling-arrest episode). Section two is the substance: Du's disciples used as hired thugs at Lu Xun's 1936 funeral; the 1937 gang levies organized as the 别动军 / Loyal and Patriotic Army; the SACO training-camp mission of June 1945 with Miles; the brokering of the 高陶 (Gao-Tao) defection from Wang Jingwei through 徐寄庼 and 黄溯初; Du's repeated interest-free loans to the cash-strapped Juntong; the Tongji Company yarn-and-cloth operation (the four-banks board, Zhu Huiqing, Lin Yaomin); Dai using Du to court and then to help kill 王亚樵 Wang Yaqiao, and to court the Sichuan Paoge in Chongqing (the protected gambling at Fan Shaozeng's); and the postwar Shanghai property recoveries (Route Doumer, the Zhengshi Middle School). Section three carries Du's post-1946 dealings with the Juntong's successor Baomiju through Zheng Jiemin, Mao Renfeng and the liaison man Wang Xinheng, down to the last Hong Kong loan of 1949.

**Checks:** parity 46/46; check_align OK (median 5.23 en/han, no pair strays); check_numbers 0 unresolved with the new ch21 noise block; check_content ch21 clean (240 name occurrences, all in the paired paragraph, no new cross-chapter displacements); qc_entities 0 misses; check_register within tolerance vs ch03. qa_epub PASS (368 notes, all refs/bodies/backlinks resolve); epubcheck 5.1.0 clean (0 fatals / 0 errors / 0 warnings). The three standing content-check flags (ch03 p29 Wu Shaoshu, ch13 p39-41 Avenue Foch, ch13 p58 Fu Xiao'an) are pre-existing B10 items and were not touched by this batch.

**Tooling:** one small, safe additive patch to `scripts/check_numbers.py` (added "ten/eleven/twelve/thirteen" to the million/billion name set, so 一千万 = "ten million" is recognized; target-side only, so it can only add a recognized value and never mask a source drop, same safety class as the ORDINALS block). Both check_numbers regression fixtures still pass. `data/noise.txt` gained a ch21 block: 二千六百多万 (a numeral compound split by 多), 二十亿 (2 billion; simplified 亿 is not summed by cn_to_int, so the token mis-reads as a bare 20 and the English "two billion" carries the value), and the name-numerals 忠五 (许忠五) and 三有 (三有公司). `data/ocr_fixes.json` gained a 27-entry ch21 block. work/content_cfg.json regenerated over all 21 translated units.

**Left unglossaried, book-inconsistent (B10 items):** 特务处 (earlier chapters render it differently or not at all; ch21 uses "the Special Services Department"); 四大家族 (earlier chapters use both "Four Big Families" and "Four Great Families"; ch21 uses "Four Big Families"); 八一三 (earlier: both "August 13" and "August Thirteenth"; ch21 uses "August Thirteenth"); 税警总团 (rendered "the Revenue Guard" in ch21, not glossed pending a check of earlier usage). All are internally consistent within ch21.

**Source apparatus reproduced:** the chapter carries two editors' notes (circled numerals), both reproduced as translator notes that say they are the source's: on 第四支队长为张范 ("per Zhu Xuecang this should be Zhang Ye") and on the 1935 Nanjing assassination attempt ("one account has this operation organized by Hua Kezhi," which scholarship bears out). The 王亚樵 killing is dated late November 1936 in the source; the note records the usual date of October 1936. The muddled 1945 route (贵阳→芷江→建阳) was crop-verified and reads coherently.

## B09 (ch22-ch24) COMPLETE

**The Zhang Xiaolin cluster.** Three separate articles, three narrators, three new files (out/ch22-24_reading.md + data/zh/ch22-24.txt). ch22 张啸林的一生 ("The Life of Zhang Xiaolin," Zhu Jianliang and Xu Weizhi, printed 342-346, PDF 351-355), 16 body paragraphs, 8 notes. ch23 我所知道的张啸林 ("The Zhang Xiaolin I Knew," Yu Yunjiu, printed 347-349, PDF 356-358), 9 paragraphs, 6 notes. ch24 上海三大亨的勾结和斗争 ("The Collusion and Rivalry of Shanghai's Three Big Bosses," Shi Jun, printed 350-356, PDF 359-365), intro plus five numbered sections and 18 body paragraphs, 6 notes. Glossary grew from 757 to 910 rows across the batch; the book now carries 388 notes.

**ch22.** A compact hostile biography: Zhang's Hangzhou-gambler youth, his move to Shanghai under Ji Yunqing, the Green Gang master Fan Jincheng, the opium partnership and Rue Wagner houses, the April 12 role, the 1930s rift with Du, and his open collaboration and 1940 assassination by his bodyguard Lin Huaibu. The name/tiger wordplay (Ah Hu, Yin, the two homophonic Xiaolins), Ji Yunqing, Zhang Zuolin, the Zhejiang warlords Lu Yongxiang and He Fenglin, the 1935 fabi reform, the New Asia Peace Promotion Association, the assassination (with its scholarly wrinkle: Chen Gongshu of the Juntong disclaimed it and Lin's confession cited a private grievance), and the Tinfoil Bureau all earned notes.

**ch23.** A detail-dense insider account that CONTRADICTS ch22 on Zhang's origins: ch22 makes him Cixi-born and following Ji Yunqing to Shanghai, ch23 makes him Hangzhou-born (outside the Qiantang Gate) and following the ex-policeman Wu Hong. Both are rendered as printed and the discrepancy is footnoted (standard works follow the Cixi account). This chapter is where the major foreign and collaborator names appear: Doihara Kenji and Nagano Osami, Yin Rugeng, Wellington Koo and Chu Minyi, the ninth Panchen Lama's 1934 Shanghai visit (a patriotic anti-Japanese figure feted by a man courting Japan, an irony noted), and Chen Gongbo, Zhou Fohai and Jiang Kanghu, all footnoted (Chu Minyi and Zhou Fohai cross-referenced to their earlier notes).

**ch24.** The set piece: a Huang-gate newspaperman's insider account of the three bosses from Huang's Shiliupu beginnings through the concession-police opium system, the Sanxin Company, the three-way friction, and the press faction war the narrator himself ran for pay. Very name-dense (dozens of gang toughs, French officers, opium bosses, and two long rosters of journalists sorted by faction); the whole cast was crop-verified against the scan and check_align showed no tail drops. Notes were placed for Fiori and the concession-police opium partnership, the 1923 Lincheng train-hijacking, the "raking the ashes" incest idiom, the narrator's own partisan role, the mosquito-press world, and the opium grades.

**Checks (all three units).** parity 18/18, 10/10, 20/20; check_numbers 0 unresolved; check_align no outliers (medians 5.15/5.39/5.17 en/han, nothing past 2.2x); check_content clean for all three across the whole book; qc_entities 0 misses; check_register within tolerance of ch03 (ch24's 16 contractions/1k is the opium-negotiation dialogue, allowed). check_apparatus 0 failures. qa_epub PASS (24 of 28 chapters, 1154 paragraphs, 388 notes all resolving); epubcheck 5.1.0 clean (0 fatals / 0 errors / 0 warnings). setup.sh reported the one expected checker-test FAIL ("hook stands down on template stub," because a real kickoff sits in HANDOFF); the two enforcing hook paths pass, and the hook was not touched.

**noise.txt additions.** ch23 block: 俞云九 (the byline, 九 is the name) and 百忍堂 (Bairen Tang, 百 is the hall-name). ch24 block: 三光 (the gang term), 五龙池 (bathhouse), 叶焯三 and 袁三宝 (name-numerals), 三位一体 (trinity idiom), 七日一周 (a weekly cycle). One structural fix: a 万千 rule ("myriad thousands," from 骗钱万千) had to be inserted BEFORE the general bare-万 (surname Wan) rule, because that rule strips the 万 and orphans a 千 read as 1000; the comment in the file marks the ordering as load-bearing. The 五马路/四马路 entries added while drafting ch22 were removed once the streets were rendered "Fifth/Fourth Avenue" (the collection's form, which carries the numeral target-side).

**Crop-verified readings (data/ocr_fixes.json, ch22/ch23/ch24 keys).** ch22 (27 entries): the birthplace 慈谿县, father 木匠 (a carpenter, not a name), 樊瑾丞, 范开泰/范回春/苏嘉寿, 三鑫公司, 华格臬路, 每吾生, 张法尧, 俞叶封, 吴静观, 锡箔局, the "黑心钱公平用" pact. ch23 (33 entries): 张寅字啸林, 撩鬼儿, 蒙古桥, 燕子窠, 土肥原/永野修身, 殷汝耕, 俞肇桐/郑子褒, 顾维钧/褚民谊, 恒社/忍庐. ch24 (43 entries): the gang-tough roster, 费沃利/萨维尼, 广东桂林, 瞿龙龙, the shop names, 程子卿/金九林, 郭海珊/沈杏山, the opium-lieutenant list, 孙美瑶/穆安素/高士奎, the two journalist rosters, 邵文滨, 房帏中事, 大阪码头, and the deaths (Du 1951, Huang 1953, consistent with ch12).

**Glossary discipline / cross-chapter reconciliation.** Adding rows retro-flagged several earlier chapters, all resolved to the established form: 王柏龄 = "Wang Bailing", 莫干山 = "Moganshan" (ch22); 费沃利 = "Fiori" (ch08), 西藏路 = "Xizang Road" (ch10), 郑家木桥 = "Zhengjia Wooden Bridge", 杭州阿发 = "Hangzhou A-fa", 金陵东路 = "East Jinling Road", 中华共进会 = "the China Mutual Progress Society" (ch24). Left UNGLOSSARIED and logged for B10 (frozen-chapter variance): 延安中路 and 延安东路 (modern-name glosses handled inconsistently), 爱多亚路 ("Avenue Edward VII" vs ch08's "Avenue Edouard VII"), 钧培里 (rendered "Junpeili" in ch13/14/24 but paraphrased in ch17), 小阿荣 (varies vs ch20). The generic pen-name rows 石君 and 阿发 were pulled because as two-character strings they false-matched inside earlier chapters.

**Voice sheets (new).** ZHU JIANLIANG / XU WEIZHI (ch22): compilers of a terse hostile life-sketch, chronological and unpolemical in the particulars, strongest on dates and offices. YU YUNJIU (ch23): a documentary insider, anecdote-rich and knowing, dense with names and vice-trade detail, frank about Zhang's Japanese ties. SHI JUN (ch24): a pen-named Huang-gate newspaperman, worldly and self-incriminating, who ran Huang's press war against Du for pay; colorful with gang cant and dialogue, and a declared partisan of the Huang faction, so his tallies of who stood where lean Huang-ward.

**NOT re-noted in B09 (placed earlier, cross-referenced instead):** the "three big bosses" and the Green Gang generation-characters (ch01/ch05/ch12); the "old man" master-disciple bond (ch10/ch15); the April 12 coup (ch02); the Sanxin Company (ch13); sworn brotherhood (ch15); the Great World and Huang Chujiu (ch15); Chu Minyi (ch08); Zhou Fohai (ch11); the Zhonghui Bank (ch16); Dai Li and the Juntong, Chiang Kai-shek, H. H. Kung, T. V. Soong (earlier). New reader notes were placed only for genuinely fresh material.

**Open for B10.** The reconciliation list above (延安中路/延安东路/爱多亚路/钧培里/小阿荣) joins the standing items (社会局; 特务处/四大家族/八一三/税警总团; the three ch20 street names; the Montauban/Montigny call; 林尧民 vs "Lin Fanmin"; the latents ch03 p29, ch13 p39-41 and p58). The ch22-vs-ch23 birthplace contradiction is deliberate (both faithful, footnoted) and needs no fix. A scholarship pass could firm up the many provisional minor-cast romanizations (每吾生, 洪纠咎, 邵文滨, and the journalist rosters).

**Tooling:** no script changes this batch. work/content_cfg.json regenerated over all 24 translated units (work/ is gitignored).

## B10 (ch25-ch28) COMPLETE, and the BOOK IS COMPLETE

**The final batch.** The two Gu Zhuxuan pieces plus the two Heng Society appendices, then the whole-book close-out. Four new files (out/ch25-28_reading.md + data/zh/ch25-27.txt; ch28 is a described appendix with no parallel zh). ch25 顾竹轩在闸北发迹和开设天蟾舞台 ("How Gu Zhuxuan Rose in Zhabei and Opened the Tianchan Stage," Wang Delin, printed 357-359), 9 body paragraphs, 7 notes. ch26 我利用顾竹轩的掩护进行革命活动 ("Revolutionary Work Under Gu Zhuxuan's Cover," Gu Shuping, printed 360-366), 22 body paragraphs, 11 notes. ch27 恒社社章 (the Heng Society charter, 13 articles in 6 chapters, printed 367-368), legal-document register, 2 notes. ch28 恒社社员录 (the 1934 member roll, printed 369-382), a described appendix, 1 note. The book now carries 409 notes; the glossary settled at 920 rows.

**ch25.** A plain insider sketch by a man who served as a company commander under Gu in the Zhabei Defense Corps: Gu the Yancheng rickshaw-puller who became the "north-station" boss, his patron Cao Youshan of the "Da" generation, the Qi-Lu-War-era defense corps under Wang Yanbin, and the Tianchan Stage he built opposite the Dangui, ending in the shooting of the actor Chang Chunheng. Notes placed for the Subei/Jiangbei stigma (cross-referenced to ch08), the Green Gang generations (ch05), the Qi-Lu War, the Songhu Garrison Command, the "tiger's skin" idiom, the play Kaitian Pidi, and the Chang Chunheng killing (which corrects a "beaten to death" claim carried in the old glossary note to the source's "shot with a Mauser").

**ch26.** A sympathetic-insider memoir by Gu's nephew, an underground CPC worker: the 1943 escort of Yu Ping and Li Feng to Yan'an via a Dongtai grain-merchant and a Shanghai temple, the 1945 hospital run for Lin Li, and the postwar Gang Work Committee, the Yulin-district deputy-headship, and the Meng Xinmin exposure. Very name-dense with real historical figures; notes placed for the First Revolutionary Civil War, the Enemy-Work Department, Lan County as a Yan'an transit point, the Wang puppet regime, Li Guichun/Li Shaochun, Huang Kecheng, Ma Shuli, Mao Sen, the 1951 zhenfan campaign, the two-contributor discrepancies with ch25, and the age arithmetic (born 1885, died 1956, printed "seventy-five").

**ch27-ch28 (the appendices).** The charter was translated as numbered legal articles, register kept formal, with one cross-reference note to "Du Yuesheng and the Heng Society" (ch20) and a note on the dues. The 1934 roll was DECIDED as a described appendix rather than a forced 324-name transcription: a list of 324 OCR'd personal names cannot be romanized name-by-name to this project's fidelity standard (a mis-read stroke becomes a fabricated person), so the appendix analyzes the roll's composition (Jiangsu ~111, Zhejiang ~95, Shanghai ~58, Anhui ~16, scattered others; occupations spanning business, banks, the law, medicine, the postal service, the press, the Social Affairs and Public Security bureaus, and the opera world, including Ma Lianliang) and reproduces the first fourteen entries, each crop-verified. The roll's own stated total, 324, was crop-read from the last page.

**Checks (B10 units).** parity 9/9 (ch25... counting byline, 10 pairs), 22/22 (23 pairs), 13/13; check_numbers 0 unresolved; check_align within tolerance (medians 5.28/4.71/5.48 en/han); qc_entities 0 misses; check_register within tolerance of ch03. check_apparatus 0 failures. Book-wide check_content exit 0; check_reconcile exit 0. qa_epub PASS (28 of 28 chapters, 1213 paragraphs, 409 notes all resolving, 22 pagebreaks); epubcheck 5.1.0 clean (0/0/0/0).

**Whole-book reconciliation (check 12), resolved this batch.** (a) check_content latents fixed: ch03 had a real name error, 吴绍澍 rendered "Wu Xingya" (confused with the Social Affairs Bureau's Wu Xingya), corrected to "Wu Shaoshu"; ch13 "Rue Foch" unified to "Avenue Foch" and "Fu Xiaoan" to "Fu Xiao'an". (b) One spelling locale: cascaded to American across readings, notes, glossary and book.json (favour/labour/theatre and a capital "Labour" in a note; "greyhound" was protected as the correct fixed spelling after an over-eager cascade nicked it). (c) Street/name drift: 爱多亚路 unified to "Avenue Edward VII"; the Yan'an-road glosses unified to "[Name] East/Middle Road" (dropping "East/Central Yan'an Road"); 四大家族 to "the Four Big Families"; 小阿荣 to "Little Ah Rong"; 申报 to "Shen Bao" (prose, glossary and authority). (d) Confirmed NON-issues: "Lin Fanmin" (ch20, 林范民, a chief auditor) is a different person from "Lin Yaomin" (ch21, 林尧民); 钧培里 ("Junpeili") and Montauban were already consistent; 社会局 is uniformly "Social Affairs Bureau"; the 154 epithet-drift candidates are legitimate hyphen-compound variety. (e) 方治 was pulled from the glossary because it false-matches 地方治安.

**Deliverables.** out/term_ledger.md (920 rows, grouped and status-marked). out/deep_audit.md (3.5% random sample, seed 54, 42 paragraphs, zero substantive errors, rate below ~7% at 95%). COMPLETION.md written from the template. authority.json fed this book's decided renderings under slug "gangs-of-old-shanghai" (43 existing renderings tagged, 282 attested/principal entries added; the one real cross-shelf difference, 申报, resolved to "Shen Bao"). back_matter.json left inert (no errata; colophon data lives in book.json source_ref) by decision.

**noise.txt additions.** ch26 block: 四郊 ("the outskirts," 四 is the fixed compound).

**Crop-verified readings (data/ocr_fixes.json, ch25-ch28 keys).** ch25: 顾竹轩/曹幼珊/王彦彬, 潭子湾, 署长, 天蟾舞台. ch26: 如茂 (courtesy name), 团长, 商团会董, 刘登阶, 唐君照/喻屏/李枫, 敌工部, 王建斋, 曹小洪/曹润之, 顾月波, 牯岭路/地藏寺, 湖北路迎春坊, 山西岚县, 甲状腺肿大症, 田云樵, 顾轩吾, plus the historical cast verified against knowledge. ch27: the article-6 phrase. ch28: 王叔和/王咏梅/方镇耀 in the sample, and the 324 total.

**Voice sheets (new).** WANG DELIN (ch25): a matter-of-fact corps insider, plain and mildly disapproving, strong on organizational detail. GU SHUPING (ch26): Gu Zhuxuan's nephew and an underground CPC worker, earnest and grateful in register, the sympathetic-insider counterweight to the hostile three-bosses pieces.

**Status: the book is COMPLETE.** See COMPLETION.md. Further work is a corrections pass.
